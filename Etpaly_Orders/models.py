...
class Order(models.Model):
    ...
    cash=discount=models.IntegerField(_("Cash"),null=True , blank=True,default=0)
    transfer=discount=models.IntegerField(_("Transfer"),null=True , blank=True,default=0)
