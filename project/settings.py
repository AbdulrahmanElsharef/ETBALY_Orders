...
SECRET_KEY = 'django-insecure-9%dkp^vq@dtwiuim3qn9(35av6a1i3ouwf-!wwl944%vd!jwof'
...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "Etbaly_Orders",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "ETbaly_SHokran",
    ...
    "welcome_sign": "Welcome to Etbaly_SHokran",
    ...
    # "search_model": ["Customer.name", "Order.code"],
